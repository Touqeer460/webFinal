...
(function ($, uship) {
    ...
    function toggleMode() {
        ...
        modeToggle.click(function (event) {
            event.preventDefault();
            event.stopPropagation();
        });
    ...
    function addExitLinkAnalytics() {
        ...
        uship.recorder.linkClick('#howitworks-header-link', 'How It Works', { 'type': 'Exit Link Click' }, ['GA']);
        uship.recorder.linkClick('#help-header-link', 'Help', { 'type': 'Exit Link Click' }, ['GA']);
    }
